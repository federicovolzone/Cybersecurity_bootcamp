Clicca "+" → Create new file dal repo principale, scrivi nel campo nome:
lab-04-caesar-rsa/README.md
Incolla questo:
markdown# Lab 04 — Caesar Cipher & RSA
...
## Concetti chiave
- Caesar vulnerabile al brute force — solo 25 chiavi possibili
- RSA si basa sulla difficoltà di fattorizzare grandi numeri primi
- Padding OAEP fondamentale — senza è vulnerabile ad attacchi statistici
- Crittografia asimmetrica risolve il problema dello scambio di chiavi
